...
#define ALLOC_GROUNDED_SUBGOAL_FRAME(STR) ALLOC_STRUCT(STR, GLOBAL_PAGES_retroactive_sg_fr, struct retroactive_subgoal_frame)
#define FREE_GROUNDED_SUBGOAL_FRAME(STR) FREE_STRUCT(STR, GLOBAL_PAGES_retroactive_sg_fr, struct retroactive_subgoal_frame)
