...
#define ALLOC_RETROACTIVE_SUBGOAL_FRAME(STR) ALLOC_STRUCT(STR, GLOBAL_PAGES_retroactive_sg_fr, struct retroactive_subgoal_frame)
#define FREE_RETROACTIVE_SUBGOAL_FRAME(STR) FREE_STRUCT(STR, GLOBAL_PAGES_retroactive_sg_fr, struct retroactive_subgoal_frame)
...
#define ALLOC_LONG_TST_NODE(STR)        ALLOC_NEXT_FREE_STRUCT(STR, GLOBAL_PAGES_long_tst_node, struct long_time_stamped_trie_node)
#define ALLOC_FLOAT_TST_NODE(STR)       ALLOC_NEXT_FREE_STRUCT(STR, GLOBAL_PAGES_float_tst_node, struct float_time_stamped_trie_node)
...
#define ALLOC_LONG_TST_NODE(STR)        ALLOC_STRUCT(STR, GLOBAL_PAGES_long_tst_node, struct long_time_stamped_trie_node)
#define ALLOC_FLOAT_TST_NODE(STR)       ALLOC_STRUCT(STR, GLOBAL_PAGES_float_tst_node, struct float_time_stamped_trie_node)
...
#define FREE_LONG_TST_NODE(STR)         FREE_STRUCT(STR, GLOBAL_PAGES_long_tst_node, struct long_time_stamped_trie_node)
#define FREE_FLOAT_TST_NODE(STR)        FREE_STRUCT(STR, GLOBAL_PAGES_float_tst_node, struct float_time_stamped_trie_node)
